...
FOR EACH ROW
BEGIN
	SET NEW.name = CONCAT(UPPER(SUBSTRING(NEW.name,1,1)),LOWER(SUBSTRING(NEW.name,2,LENGTH(NEW.name))));
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER after_update
AFTER UPDATE ON language
FOR EACH ROW
BEGIN
	INSERT INTO UPDATE_INFO(old_name,updated_name,update_time)
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GETRENTALBYCUSTOMER`(CUS_ID INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CONCATNAME`(FIRST_NAME VARCHAR(100),LAST_NAME VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERTLANG`(NAMELANG VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERTLANGRETURN`(IN LANGNAME VARCHAR(100),OUT NEWLANGID INT)
BEGIN
	INSERT INTO LANGUAGE(name,last_update)
    VALUES (LANGNAME,NOW());
...
-- Dump completed on 2022-10-02 19:54:47
